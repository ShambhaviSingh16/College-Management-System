...
if (isset($_COOKIE['flag'])) {
  ...
  <body>
    ...
    <div class="content" id="content">
      <form class="registration-form" id="LeaveRequest" action="../Controller/LeaveCheck.php" method="post"
        onsubmit="return LeaveRequest()">
        <fieldset>
          ...
          <table align="center">
            ...
            <tr>
              <td>Leave_From</td>
              <td>: <input type="text" id="leave_from" name="leave_from" disabled
                  value="<?php echo $User['leave_from']; ?>"></td>
            </tr>
            <tr>
              <td>Leave_To</td>
              <td>: <input type="text" id="leave_to" name="leave_to" disabled value="<?php echo $User['leave_to']; ?>">
              </td>
            </tr>
            <tr>
						<td>Action</td>
