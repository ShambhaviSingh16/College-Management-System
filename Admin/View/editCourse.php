...
<head>
  ...
  <script src="../Script/addStuValidation.js"></script>
...
<body>
  ...
  <div id="content">
    <form class="registration-form" id="inform" action="../controller/updateCheckCourse.php"
        ...
        <table align="center">
          ...
          <tr>
            ...
            <td>:<select id="classE" name="class">
                ...
                <option <?php if ($updatemyinfo['class'] == "Computer Science") { ?> selected="true" <?php } ?> value="Computer Science">Computer Science
                </option>
                <option <?php if ($updatemyinfo['class'] == "Mechanical") { ?> selected="true" <?php } ?> value="Mechanical">Mechanical
                </option>
                <option <?php if ($updatemyinfo['class'] == "Management") { ?> selected="true" <?php } ?> value="Management">Management
                </option>
                <option <?php if ($updatemyinfo['class'] == "Bussiness") { ?> selected="true" <?php } ?> value="Bussiness">Bussiness
              </option>
                <option <?php if ($updatemyinfo['class'] == "Civil") { ?> selected="true" <?php } ?> value="Civil">Civil
                </option>
              </select>
            </td>
          <tr>
            ...
            <td><textarea id="description" name="description" rows="3"
                cols="20"><?php echo $updatemyinfo['description']; ?></textarea></td>
          </tr>
