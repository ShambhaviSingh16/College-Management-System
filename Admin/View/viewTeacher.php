...
<head>
  ...
  <span style="font-size:30px;cursor:pointer" onmouseover="openNav()">&#9776;</span>
    <script type="text/javascript" src="../script/TeacherSearch.js"></script>
  <div class="content" id="content">

    <form class="table-responsive" id="inform" action="../Controller/updateCheckTeacher.php"
        ...
        <?php
          ...
          for ($i = 0; $i < count($UsersList); $i++) {
            echo "<tr align = 'center'>
                ...
                <td> <a href='editTeacher.php?id={$UsersList[$i]['id']}'> Edit </a> |
                 <a href='deleteTeacher.php?id={$UsersList[$i]['id']}'> Delete </a> </td>
            </tr>";
          }
          echo "</table>";
          ?>
