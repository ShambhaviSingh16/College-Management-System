...
<body>
  ...
  <div id="content">
    <form class="registration-form" id="myform" action="../Controller/regCheck.php" onsubmit="return validation()" method="post">
      <fieldset>
        ...
        <center>
        <input type="submit" id="submit" name="register" value="Registration">
