...
$javascript = "../Script/teacherNoteSearch.js";
...
<head>
  ...
  <title>View Teacher's Notes</title>
  <link href="../../Home/Resources/bu logo..png" rel="icon"> 
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <script src="../Script/TeacherNoteSearch.js"></script>
  <style>
      body {
  ...
  <body>
    ...
    <div class="content" id="content">
      <form class="" action="" method="post">
        ...
        <fieldset>
          <legend>TEACHER'S NOTES</legend>
          <script type="text/javascript" src="../Script/TeacherNotesSearch.js"></script>
          
            <center>
              <b>Find Notes:</b> <input type="text" name="name" id="name" onkeyup="ajax()" />
