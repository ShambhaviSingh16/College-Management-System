...
<body>
  ...
  <div class="content" id="content">
    <form class="registration-form" id="inform" action="../Controller/requestbookCheck.php" method="post">
      <fieldset>
        ...
        <table align="center">
          ...
          <tr>
            <td>Student id</td>
            <td>:</td>
            <td> <input type="number" id="" name="id" value=""></td>
          </tr>

          <tr>
            <td>ISBN</td>
            <td>:</td>
            <td> <input type="number" id="" name="isbn" value=""></td>
          </tr>
          ...
          <tr>
            <td>EDITION</td>
            <td>:</td>
            <td> <input type="text" id="edition" name="edition" value=""></td>
          </tr>
        </table>
        <hr>
        <center>
