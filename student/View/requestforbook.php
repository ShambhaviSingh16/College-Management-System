...
$request_directory ="/../librarian/View/student_requests/";
?>
<!DOCTYPE html>
<html>
...
<body>
  ...
  <form class="registration-form" action="process_request.php" method="post">
  <fieldset>
        ...
        <table align="center">
          ...
          <tr>
          <td>ID</td>
          <td>:<input type="text" id="id" name="id" required></td></tr>

          <tr>
          <td>ISBN No.</td>
          <td>:<input type="text" id="isbn" name="isbn" required></td></tr>
