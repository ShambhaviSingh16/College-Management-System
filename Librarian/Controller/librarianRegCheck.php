...
if(isset($_POST['register'])){
    ...
    if(mailValidation($mail) && nameValidation($name) && librarianidValidation($librarianid) && genderValidation($gender) && mobilenoValidation($mobileno) && passwordValidation($password)){
