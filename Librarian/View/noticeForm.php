...
<body>
  ...
  <div class="content" id="content">
    <form class="registration-form" id="inform" action="../Controller/noticeCheck.php" method="POST"
      onsubmit="return bookarrivalnotice()">
      <fieldset>
        ...
        <table align="center">
          ...
          <tr>
            <td><textarea rows="8" cols="80" name="noticedetails" id="noticedetails"placeholder="Enter notice Here" onkeypress="validation()"></textarea>
              <div id="msg2"></div>
            </td>
          </tr>
        </table>
        <hr>
        <center>
          <input type="submit" name="update" value="Upload Notice">
