...
<body>
  ...
  <div class="content" id="content">
    <form class="table-responsive" id="inform" action="../Controller/" method="post">
      <fieldset>
          ...
          <tr>
            ...
            <?php for ($i = 0; $i < count($allIssuedBookDetails); $i++) {
              echo "<tr align = 'center'>
                   <td>{$allIssuedBookDetails[$i]['isbn']}</td>
                   <td>{$allIssuedBookDetails[$i]['title']}</td>
                   <td>{$allIssuedBookDetails[$i]['id']}</td>
                   <td>{$allIssuedBookDetails[$i]['issuesdate']}</td>
                   <td>{$allIssuedBookDetails[$i]['returndate']}</td>
                   <td>{$allIssuedBookDetails[$i]['returnstatus']}</td>
                   <td>{$allIssuedBookDetails[$i]['fine']}</td>
                   <td><a href='addFine.php?id={$allIssuedBookDetails[$i]['id']}'>Edit</a></td>
                  </tr>";
            } ?>
        </table>
      </fieldset>
