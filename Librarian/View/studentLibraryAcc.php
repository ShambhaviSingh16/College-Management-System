...
<body>
  ...
  <div class="content" id="content">
    <form class="registration-form" id="inform" form action="../Controller/studentAccCheck.php" method="POST"
      onsubmit="return studentLibAcc()">
      <fieldset>
        <legend>STUDENT LIB ACCOUNT</legend>
        <table align="center">
          <tr>
            <td colspan="2">
              <center>
          ...
          <tr>
            ...
            <td>: <input type="text" name="sturoll" id="sturoll" onkeypress="validation()">
              <div id="msg1"></div>
            </td>
          </tr>
        </table>
