...
<body>
  ...
  <div class="content" id="content">
    <form class="table-responsive" id="inform" action="" onsubmit="return validation()" method="post">
      <fieldset>
        ...
        <div id="viewstudentlist" class="">
          ...
          <?php for ($i = 0; $i < count($studentsinfo); $i++) { ?>
            <tr>
             <td>
                <?php echo $studentsinfo[$i]['id'] ?>
              </td>
              <td>
                <?php echo $studentsinfo[$i]['name'] ?>
              </td>
              <td>
                <?php echo $studentsinfo[$i]['email'] ?>
              </td>
              <td>
                <?php echo $studentsinfo[$i]['mobile'] ?>
              </td>
              <td>
                <?php echo $studentsinfo[$i]['gender'] ?>
              </td>
              <td>
                <?php echo $studentsinfo[$i]['dob'] ?>
              </td>
              <td>
                <?php echo $studentsinfo[$i]['class'] ?>
              </td>
              <td>
                <?php echo $studentsinfo[$i]['section'] ?>
              </td>
              <td>
                <?php echo $studentsinfo[$i]['id'] ?>
              </td>
              <td>
                <?php echo $studentsinfo[$i]['p_address'] ?>
              </td>
            </tr>
          <?php } ?>
        </table>
