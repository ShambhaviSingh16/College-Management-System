...
<body>
  ...
  <div class="content" id="content">
    <form class="table-responsive" id="inform" action="" method="post">
      <fieldset>
        <legend>VIEW STUDENT LIBRARY ACCOUNT</legend>
    ...
    <div id="notice">
        <table border="1" width="100%" cellspacing="0">
          ...
          <?php for ($i = 0; $i < count($viewAllStudentsLibProfile); $i++) { ?>
            <tr>
              <td>
                <?php echo $viewAllStudentsLibProfile[$i]['id'] ?>
              </td>
              <td>
                <?php echo $viewAllStudentsLibProfile[$i]['name'] ?>
              </td>
              <td>
                <?php echo $viewAllStudentsLibProfile[$i]['mail'] ?>
              </td>
              <td>
                <?php echo $viewAllStudentsLibProfile[$i]['gender'] ?>
              </td>
              <td>
