      ...
      <fieldset>
        ...
        <table border="1" width="100%" cellspacing="0">
          ...
          <?php for ($i = 0; $i < count($teachersilist); $i++) { ?>
            <tr>
              <td>
                <?php echo $teachersilist[$i]['id'] ?>
              </td>
              <td>
                <?php echo $teachersilist[$i]['name'] ?>
              </td>
              <td>
                <?php echo $teachersilist[$i]['email'] ?>
              </td>
              <td>
                <?php echo $teachersilist[$i]['mobile'] ?>
              </td>
              <td>
                <?php echo $teachersilist[$i]['gender'] ?>
              </td>
              <td>
                <?php echo $teachersilist[$i]['dob'] ?>
              </td>
            </tr>
          <?php } ?>
        </table>
