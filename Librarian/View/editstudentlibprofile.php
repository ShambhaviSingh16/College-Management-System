...
<body>
  ...
  <div class="content" id="content">
    <form class="registration-form" id="inform" action="../Controller/editStudentLibProfileCheck.php"
      ...
      <fieldset>
        ...
        <hr>
        <center>
          <input type="submit" name="editstudentlibprofile" value="Update Profile">
