...
<body>
  ...
  <div class="content" id="content">
    <form class="registration-form" id="inform" action="../Controller/updateBookInfoCheck.php" method="post">
      <fieldset>
        ...
        <hr>
        <center>
          <input type="submit" name="updatebookinfo" value="Update Book Info">
