...
<body>
  ...
  <div class="content" id="content">
    <form class="registration-form" id="inform" action="../Controller/issueNewBookCheck.php" method="post"
      onsubmit="return issuenewbook()" enctype="multipart/form-data">
      <fieldset>
        <legend>ISSUE NEW BOOK </legend>
        <table align="center">
          <tr>
            <td colspan="2">
              <center>
          ...
          <tr>
            <td>Student Id :</td>
            <td><input type="text" name="studentroll" id="studentroll" value="" onkeypress="validation()">
              <div id="msg1"></div>
            </td>
          </tr>
          <tr>
            <td>ISBN Number :</td>
            <td><input type="text" name="isbnno" id="isbnno" value="" onkeypress="validation()">
              <div id="msg2"></div>
            </td>
          </tr>
          <tr>
            <td>Book title :</td>
            <td><input type="text" name="title" id="title" value="" onkeypress="validation()">
              <div id="msg2"></div>
            </td>
          </tr>
        </table>
        <hr>
        <center>
          <input type="submit" name="update" value="Issue Book">
