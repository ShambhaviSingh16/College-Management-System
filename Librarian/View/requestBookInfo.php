...
<body>
  ...
  <div class="content" id="content">
    <form class="table-responsive" id="inform" form action="../Controller/searchBookCheck.php" method="post">
      <fieldset>
        <legend>REQUEST OF BOOK</legend>
        <br>
        <table border="1" width="100%" cellspacing="0">
          ...
          <tr>
            ...
            <tr>
              <td>
                <?php echo $requestBookInfo[$i]['sl'] ?>
              </td>
              <td>
                <?php echo $requestBookInfo[$i]['isbn'] ?>
              </td>
              <td>
                <?php echo $requestBookInfo[$i]['title'] ?>
              </td>
              <td>
                <?php echo $requestBookInfo[$i]['author'] ?>
              </td>
              <td>
                <?php echo $requestBookInfo[$i]['edition'] ?>
              </td>
              <td>
                <?php echo $requestBookInfo[$i]['id'] ?>
              </td>
              <td>
                <?php echo $requestBookInfo[$i]['requestdate'] ?>
              </td>
