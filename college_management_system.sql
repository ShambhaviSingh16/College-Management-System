...
(5, '1250773975', 'A Child Called ''It'' : One Child''s Courage To Survive', 'elzer, David J', '2nd edition', 'Fiction', '', '12'),
(6, '1250773980', 'I Know Why The Caged Bird Sings', 'Angelou, Maya', '9th edition', 'Autobiography, Biography', '', '9'),
...
(1, 'B.Com', 'Accountancy', 'Text Book Approved by BU'),
(3, 'Bsc', 'biology', 'Text Book Approved by BU'),
(4, 'BCA ', 'Web programming', 'Text Book Approved by BU'),
(5, 'BA', 'English', 'Text Book Approved by BU'),
(6, 'BCA', 'Discrete Mathematics', 'Text Book Approved by BU');
...
CREATE TABLE `routine` (
  ...
  `9:00-9:50` varchar(50) NOT NULL,
  `9:50-10:40` varchar(50) NOT NULL,
  `10:40-11:30` varchar(50) NOT NULL,
  `11:30-12:20` varchar(50) NOT NULL,
  `1:00-1:50` varchar(50) NOT NULL,
  `1:50-2:40` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `routine` (`day`, `9:00-9:50`, `9:50-10:40`, `10:40-11:30`, `11:30-12:20`, `1:00-1:50`, `1:50-2:40`) VALUES
('Monday', 'Cryptography & Networking', 'Software Engineering', 'Web Programming', 'Theory of Computation', 'Project Lab', 'Library'),
('Tuesday', 'Theory of Computation', 'Software Engineering', 'Web Programming(Lab)', 'Cryptography & Networking', 'Project Lab', 'Library'),
('Wednesday', 'Cryptography & Networking', 'Library', 'Theory of Computation', 'Software Engineering', 'Web Programming', 'Project Lab'),
('Thursday', 'Theory of Computation', 'Project Lab', 'Library', 'Software Engineering', 'Web Programming', 'Cryptography & Networking');
('Friday', 'Project Lab', 'Library', 'Software Engineering', 'Cryptography & Networking', 'Theory of Computation', 'Web Programming'),
('Saturday', 'Project Lab', 'Theory of Computation', 'Web Programming(Lab)', 'Library', 'Software Engineering', 'Cryptography & Networking'),
...
INSERT INTO `College_notice` (`id`, `notice`, `time`) VALUES
(1, 'It is to notify to all concerned that the College will remain closed (including all online classes) on Tuesday, July 30th 2023 due to Shab e-Barat, 2023.  ', '2023-07-22 11:23:55'),
(2, 'It is to notify to all concerned that the College will remain closed (including all online classes) on Sunday, August 21,  2023 due to Language Movement Day 2023.  ', '2023-08-22 11:24:04');
...
('2001', 'Kowshik Chakraborty', 'kowshik@gmail.com', '01764199181', 'male', '1984-08-09', 'Computer Science', '4567'),
('2002', 'nahin all', 'nahin@gmail.com', '01711845611', 'male', '2009-07-15', 'Civil', '1234@1234'),
('2003', 'anik saha', 'a@gmail.com', '01745361245', 'male', '2016-02-09', 'Mechanical', '12341234@'),
('2006', 'kowshik sss', 's@s.com', '01756984231', 'male', '2013-01-02', 'Civil', '12345@@123'),
('2008', 'John', 'john@gmail.com', '01758964512', 'male', '2021-04-23', 'Management', '1234567!'),
('2009', 'Kowshik Chakraborty', 'kowshik@gmail.com', '01754697845', 'Male', '2013-06-23', 'Bussiness', '1234567@'),
('2011', 'anirban', 'anirban@gmaill.com', '01711814155', 'male', '2019-03-16', 'Computer Science', '12345678@'),
('2013', 'anirban Saha', 'anirban@gmail.com', '01711811415', 'male', '2014-03-20', '', '12345678@'),
('2014', 'anik', 'a@a.com', '01776304244', 'female', '2021-03-31', 'Bussiness', '1234567@@');
